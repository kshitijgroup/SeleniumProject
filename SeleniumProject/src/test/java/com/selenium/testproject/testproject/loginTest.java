...
Assert.assertEquals("Online Bus Ticket Booking - Get Upto Rs.350 Off on Bus Booking", "Online Bus Ticket Booking - Get Upto Rs.350 Off on Bus Booking");
...
/*driver.findElement(By.xpath("//div[@class='abhi-pop-login']//*[@id='SignINAjx']")).click();
Thread.sleep(5000);
System.out.println("Step 3 : entered username password details");

String username = driver.findElement(By.xpath("//*[@id='AccLogin']/span")).getText();
System.out.println("Username displayed is "+ username);
if (username.contains("Ampy"))
{
...
Thread.sleep(1000);
driver.findElement(By.xpath("//*[@id='ui-id-1']/li[text()='Bangalore']")).click();
...
driver.findElement(By.xpath("(//a[@class='ui-state-default' and contains(text(),'24')])[2]")).click();
driver.findElement(By.xpath("//*[@id='datepicker2']")).click();
driver.findElement(By.xpath("//span[@class='ui-icon ui-icon-circle-triangle-e']")).click();
driver.findElement(By.xpath("(//a[@class='ui-state-default' and contains(text(),'28')])[1]")).click();
Thread.sleep(3000);
driver.findElement(By.xpath("//a[@class='btnab icosearch']")).click();
Thread.sleep(10000);
System.out.println("Select Ticket for boarding journey");
//js.executeScript("arguments[0].click();", driver.findElement(By.xpath("(//*[@class='mainsection']//*[@class='btnab book1'])[1]")));
//driver.findElement(By.xpath("(//*[@class='mainsection']//*[@class='btnab book1'])[1]")).click();
//action.moveToElement(driver.findElement(By.xpath("(//*[@class='mainsection']//*[@class='btnab book1'])[1]"))).build().perform();
System.out.println("Move to select button");
Thread.sleep(5000);
try {
	js.executeScript("arguments[0].click();", driver.findElement(By.xpath("(//*[@class='mainsection']//*[@class='btnab book1'])[1]")));
...
Thread.sleep(1000);
String username1 = driver.findElement(By.xpath("//*[@class='red-landmark']")).getText();
if (username1.contains("Madiwala"))
{
	System.out.println("Correct Boarding point selected");
}
else
{
	throw new IllegalArgumentException("Invalid Username found");
...
//Return Journey
//System.out.println("Select Ticket for return journey");
try {
	js.executeScript("arguments[0].click();", driver.findElement(By.xpath("(//*[@class='mainsection']//*[@class='btnab book1'])[1]")));
	System.out.println("Clicked using javascript");
} catch (Exception e) {
...
Thread.sleep(5000);
try {
	js.executeScript("arguments[0].click();", driver.findElement(By.xpath("(//*[@class='mainsection']//*[@class='btnab book1'])[12]")));
	System.out.println("Clicked using javascript");
} catch (Exception e) {
	driver.findElement(By.xpath("(//*[@class='mainsection']//*[@class='btnab book1'])[12]")).click();
	System.out.println("Clicked using webelement");
}

//driver.findElement(By.xpath("(//*[@class='mainsection']//*[contains(text(),'Select Seat')])[1]")).click();
Thread.sleep(2000);
driver.findElement(By.xpath("(//*[@class='borderdtd']//ul[2]/li[1]/a)[2]")).click();
Thread.sleep(2000);
driver.findElement(By.xpath("//*[@id='boardingpoint_id1']")).click();
Thread.sleep(2000);
driver.findElement(By.xpath("//option[contains(text(),'Velachery')]")).click();
Thread.sleep(1000);
String username2 = driver.findElement(By.xpath("(//*[@class='red-landmark'])[2]")).getText();
if (username2.contains("Velachery"))
{
	System.out.println("Correct Boarding point selected");
}
else
